  ...
  return (
    <Container>
      <section className="pt-16 pb-8 max-w-2xl mx-auto">
        <h1 className="text-3xl md:text-5xl font-extrabold text-white mb-4 tracking-tight">Contact</h1>
        ...
        <form className="bg-foreground/5 rounded-xl p-6 border border-foreground/10 shadow-sm flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              id="name"
              name="name"
              className="w-full px-3 py-2 rounded border border-foreground/20 bg-background text-white focus:outline-none focus:ring-2 focus:ring-primary-light"
          ...
          <button
            type="submit"
            className="px-6 py-3 rounded-lg bg-primary-light text-white font-semibold shadow hover:bg-primary-dark transition-colors border border-transparent cursor-not-allowed"
            disabled
          >
